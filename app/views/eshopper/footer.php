<footer id="footer"><!--Footer-->
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<?php if(isset($data['user_data']) && $data['user_data']->ranking == 'admin' ): ?>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2023 E-SHOPPING Inc. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="#">Dr S Gegana</a></span></p>
				</div>
			</div>
		</div>
