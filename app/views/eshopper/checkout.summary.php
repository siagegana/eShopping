...
<section id="cart_items">
	<div class="container">
		...
		<div class="register-req">
			<p style="text-align:center;">Please confirm if information is correct</p>
		</div><!--/register-req-->
					...
					<div class="js-order-details details">
						...
						<div style="display: flex;">
							...
							<table class="table" style="flex:1; margin: 4px">
								...
								<tr><th>Postal Code</th><td><?=$order->postal_code?></td></tr>
						...
						<table style="width:100%; background-color: #eee;">
								<tr><td style="text-align:center;padding: 1em;"><?=$order->message?></td></tr>
							</table>
						<hr>
						<h4>Order Summary</h4>
						...
						<table class="table">
							...
							<?php foreach($order_details as $details): ?>
								...
								<tbody>
									<tr>
										<td><?=$details->cart_qty?></td>
										<td><?=$details->description?></td>
										<td><?=$details->price?></td>
										<td><?=($details->cart_qty * $details->price)?></td>
