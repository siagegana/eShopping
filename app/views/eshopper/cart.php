	...
	<div class="container">
		...
		<div class="table-responsive cart_info">
			<table class="table table-condensed">
				...
				<?php endforeach; ?>
				<?php else: ?>
					<div style="font-size: 18px; text-align: center;padding: 6px;">
						No items were found in the cart
					</div>
			...
			<div class="pull-right" style="font-size: 20px">Sub Total:R<?=number_format($sub_total,2)?></div>
		</div>
